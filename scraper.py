...
class EnhancedNewsScraper:
    def __init__(self):
        ...
        {'name': 'Reuters Politics', 'url': "https://feeds.feedburner.com/Reuters/PoliticsNews", 'type': 'rss', 'weight': 0.8, 'reliability': 0.9},
        ...
        {'name': 'Investing.com', 'url': "https://www.investing.com/rss/news.rss", 'type': 'rss', 'weight': 0.75, 'reliability': 0.8},
        ]
